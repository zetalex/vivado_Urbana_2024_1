...
#
# Generated by Vivado on Tue Aug 13 14:39:55 +0200 2024
...
#
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/sources_1/imports/hdl/bd_wrapper.v"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/sources_1/new/top_Urbana.v"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/sources_1/bd/bd/ip/bd_mig_7series_0_0/mig_a.prj"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/sources_1/bd/bd/ip/bd_mig_7series_0_0/mig_b.prj"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/sources_1/imports/build/hello_world_BRAM.elf"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/sources_1/imports/Desktop/RGB_traffic_lights_BRAM.elf"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/constrs_1/imports/Downloads/Urbana.xdc"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/sim_1/imports/build/hello_world_BRAM.elf"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/sim_1/imports/Desktop/RGB_traffic_lights_BRAM.elf"
#    "C:/Users/Alejandro/Downloads/hw/hw.srcs/utils_1/imports/synth_1/bd_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/sources_1/imports/hdl/bd_wrapper.v"]"\
 "[file normalize "$origin_dir/src/sources_1/new/top_Urbana.v"]"\
 "[file normalize "$origin_dir/src/sources_1/bd/bd/ip/bd_mig_7series_0_0/mig_a.prj"]"\
 "[file normalize "$origin_dir/src/sources_1/bd/bd/ip/bd_mig_7series_0_0/mig_b.prj"]"\
 "[file normalize "$origin_dir/src/sources_1/imports/build/hello_world_BRAM.elf"]"\
 "[file normalize "$origin_dir/src/sources_1/imports/Desktop/RGB_traffic_lights_BRAM.elf"]"\
 "[file normalize "$origin_dir/src/constrs_1/imports/Downloads/Urbana.xdc"]"\
 "[file normalize "$origin_dir/src/sim_1/imports/build/hello_world_BRAM.elf"]"\
 "[file normalize "$origin_dir/src/sim_1/imports/Desktop/RGB_traffic_lights_BRAM.elf"]"\
 "[file normalize "$origin_dir/src/utils_1/imports/synth_1/bd_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set file "bd_mig_7series_0_0/mig_a.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
set_property -name "path_mode" -value "RelativeFirst" -objects $file_obj
set_property -name "scoped_to_cells" -value "bd_mig_7series_0_0" -objects $file_obj
set_property -name "scoped_to_ref" -value "" -objects $file_obj
set_property -name "used_in" -value "synthesis" -objects $file_obj
set_property -name "used_in_synthesis" -value "1" -objects $file_obj

set file "bd_mig_7series_0_0/mig_b.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file "build/hello_world_BRAM.elf"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "path_mode" -value "RelativeFirst" -objects $file_obj
...
set file "Desktop/RGB_traffic_lights_BRAM.elf"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "path_mode" -value "RelativeFirst" -objects $file_obj
set_property -name "scoped_to_cells" -value "microblaze_0" -objects $file_obj
set_property -name "scoped_to_ref" -value "bd" -objects $file_obj
set_property -name "used_in" -value "implementation" -objects $file_obj
set_property -name "used_in_implementation" -value "1" -objects $file_obj
set_property -name "used_in_simulation" -value "0" -objects $file_obj
...
set_property -name "top" -value "top_Urbana" -objects $obj
...
set file "[file normalize ${origin_dir}/src/constrs_1/imports/Downloads/Urbana.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "Downloads/Urbana.xdc"
...
set_property -name "target_constrs_file" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/Downloads/Urbana.xdc" -objects $obj
set_property -name "target_part" -value "xc7s50csga324-1" -objects $obj
set_property -name "target_ucf" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/Downloads/Urbana.xdc" -objects $obj
...
proc write_mig_file_bd_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="V3" SLEW="" VCCAUX_IO="" name="ddr3_addr[0]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U3" SLEW="" VCCAUX_IO="" name="ddr3_addr[10]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="P5" SLEW="" VCCAUX_IO="" name="ddr3_addr[11]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="V6" SLEW="" VCCAUX_IO="" name="ddr3_addr[12]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="R4" SLEW="" VCCAUX_IO="" name="ddr3_addr[1]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="P6" SLEW="" VCCAUX_IO="" name="ddr3_addr[2]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="T3" SLEW="" VCCAUX_IO="" name="ddr3_addr[3]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="T6" SLEW="" VCCAUX_IO="" name="ddr3_addr[4]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="T1" SLEW="" VCCAUX_IO="" name="ddr3_addr[5]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="V5" SLEW="" VCCAUX_IO="" name="ddr3_addr[6]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U7" SLEW="" VCCAUX_IO="" name="ddr3_addr[7]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="R7" SLEW="" VCCAUX_IO="" name="ddr3_addr[8]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U6" SLEW="" VCCAUX_IO="" name="ddr3_addr[9]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="V2" SLEW="" VCCAUX_IO="" name="ddr3_ba[0]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="V4" SLEW="" VCCAUX_IO="" name="ddr3_ba[1]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="R3" SLEW="" VCCAUX_IO="" name="ddr3_ba[2]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U1" SLEW="" VCCAUX_IO="" name="ddr3_cas_n"/>}
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="T5" SLEW="" VCCAUX_IO="" name="ddr3_cke[0]"/>}
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="P1" SLEW="" VCCAUX_IO="" name="ddr3_dq[10]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="N1" SLEW="" VCCAUX_IO="" name="ddr3_dq[11]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="R2" SLEW="" VCCAUX_IO="" name="ddr3_dq[12]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="N4" SLEW="" VCCAUX_IO="" name="ddr3_dq[13]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="P2" SLEW="" VCCAUX_IO="" name="ddr3_dq[14]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M2" SLEW="" VCCAUX_IO="" name="ddr3_dq[15]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M4" SLEW="" VCCAUX_IO="" name="ddr3_dq[1]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="K3" SLEW="" VCCAUX_IO="" name="ddr3_dq[2]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="L5" SLEW="" VCCAUX_IO="" name="ddr3_dq[3]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="L6" SLEW="" VCCAUX_IO="" name="ddr3_dq[4]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M6" SLEW="" VCCAUX_IO="" name="ddr3_dq[5]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="L4" SLEW="" VCCAUX_IO="" name="ddr3_dq[6]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="K6" SLEW="" VCCAUX_IO="" name="ddr3_dq[7]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="N5" SLEW="" VCCAUX_IO="" name="ddr3_dq[8]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M1" SLEW="" VCCAUX_IO="" name="ddr3_dq[9]"/>}
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="P7" SLEW="" VCCAUX_IO="" name="ddr3_odt[0]"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="U2" SLEW="" VCCAUX_IO="" name="ddr3_ras_n"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="M5" SLEW="" VCCAUX_IO="" name="ddr3_reset_n"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="SSTL135" PADName="T2" SLEW="" VCCAUX_IO="" name="ddr3_we_n"/>}
   puts $mig_prj_file {    </PinSelection>}
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  set microblaze_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze_riscv:1.0 microblaze_0 ]
  set_property -dict [list \
    ...
    CONFIG.C_I_LMB_PROTOCOL {0} \
    CONFIG.C_LMB_DATA_SIZE {32} \
  ...
  set_property CONFIG.NUM_PORTS {2} $microblaze_0_xlconcat
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  ...
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_mig_7series_0_166M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_mig_7series_0_166M/slowest_sync_clk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M03_ACLK]
  ...
  connect_bd_net -net rst_mig_7series_0_166M_bus_struct_reset [get_bd_pins rst_mig_7series_0_166M/bus_struct_reset] [get_bd_pins microblaze_0_local_memory/SYS_Rst]
  connect_bd_net -net rst_mig_7series_0_166M_mb_reset [get_bd_pins rst_mig_7series_0_166M/mb_reset] [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst]
  connect_bd_net -net rst_mig_7series_0_166M_peripheral_aresetn1 [get_bd_pins rst_mig_7series_0_166M/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins mig_7series_0/sys_rst]
...
cr_bd_bd ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files bd.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files bd.bd ] 
set_property IS_ENABLED "1" [get_files bd.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files bd.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files bd.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files bd.bd ] 
set_property PFM_NAME "" [get_files bd.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files bd.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files bd.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files bd.bd ] 
set_property USED_IN_SIMULATION "1" [get_files bd.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files bd.bd ] 
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/bd_wrapper.dcp" -objects $obj
